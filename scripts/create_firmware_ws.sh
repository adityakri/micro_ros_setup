...
echo "create_firmware_ws.sh line 31"
...
echo "create_firmware_ws.sh line 53"
# Checking folders
...
echo "create_firmware_ws.sh line 77"
# Check generic build
...
echo "create_firmware_ws.sh line 85"
pushd $FW_TARGETDIR >/dev/null
    # Creating dev directory
    mkdir $DEV_WS_DIR
echo "create_firmware_ws.sh line 88"
    if [ $RTOS != "host" ]; then
...
echo "create_firmware_ws.sh line 93"
...
echo "create_firmware_ws.sh line 97"  
...
echo "create_firmware_ws.sh line 112"
...
echo "create_firmware_ws.sh line 115"
